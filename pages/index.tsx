      ...
      {posts.map((post, index) => (
        <div key={index} className={`story-card__wrapper lg:col-span-4 flex flex-col`}>
          ...
          <div className={`story-card__inner lg:px-4 flex-auto dark:border-slate-600 ${index !== posts.length - 1 && 'lg:border-r'}`}>
            <Link href={`/${post.slug}`}>
              <a className={HomepageStyles.blogPostCard}>
                ...
                <div className='relative h-8 w-full my-5'>
                  <div className={`
                    ${HomepageStyles.timeToRead}
          ...
          <div className='story-card__separator lg:px-4 mt-2.5'>
