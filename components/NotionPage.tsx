    ...
    <div className='notion-page-wrapper px-4 sm:px-6 md:px-8'>
      <div className='notion-page-content max-w-3xl mx-auto pb-28'>
        <article className='relative pt-10'>
          <h1 className='text-2xl font-extrabold tracking-tight text-slate-900 dark:text-slate-200 md:text-3xl'>{pageProps && pageProps.title}</h1>
          <div className='prose prose-slate dark:prose-dark mt-6'>
